          ...
          setInterval(function(){ 
            ...
            .done(function(response){
              ...
              obj.map(function(curObj){
                  $('.practice').prepend("<h2>"+curObj.text+"</h2>");
                  $('.practice').fadeToggle();
              });
...
//      console.log(heatArray);
    ...
    function generateMarker(longitude, latitude){
      ...
      function getPoints() {
        ...
        new google.maps.LatLng(37.782919, -122.442815),
        new google.maps.LatLng(37.782992, -122.442112),
        new google.maps.LatLng(37.800619, -122.433507),
        new google.maps.LatLng(37.800721, -122.435267),
        new google.maps.LatLng(37.800619, -122.436297),
        new google.maps.LatLng(37.800590,-122.437166),
        new google.maps.LatLng(37.800302, -122.439033),
        new google.maps.LatLng(37.802010, -122.439172),
        new google.maps.LatLng(37.802756,-122.437370),
        new google.maps.LatLng(37.802303, -122.436930),
        new google.maps.LatLng(37.801467, -122.437327),
